...
public class TimeExceededException extends Exception {
	 ...
	 * <code>TimeExceededException</code> without detail message.
	 */
	 ...
	 * <code>TimeExceededException</code> with the specified detail message.
	 *
	 ...
	 * @since 1.4
	 */
	public TimeExceededException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public TimeExceededException(Throwable cause) {
		super(cause);
	}
}
